...
def main():
    ...
    for i in range(args.all_gene // args.gene_num):
        ...
        gene_order = np.load('/date/NMI/data/VisiumHD_moueembryo_sorted_data/gene_order.npy')[(n - 1) * args.all_gene + (i * args.gene_num) : (n - 1) * args.all_gene + ((i + 1) * args.gene_num)]
        ...
        save_dir = 'logs5KVisiumHDembryo/' + args.dataset_use + '_' + str(args.SR_times) + 'X' + '_G' + \
