...
class UNetModel(nn.Module):
    ...
    def __init__(
        ...
        co_expression = np.load(root + '/Xenium5k/gene_coexpre.npy')
        ...
        self.conv_layer1 = nn.Sequential(
            conv_nd(dims, 124, ch, 3, padding=1),
            nn.SiLU()
        )
...
########################################################################
        ...
        Final_merge = th.cat([Final_merge, Gene_index_map1,Gene_index_map1,Gene_index_map1], dim=1)
